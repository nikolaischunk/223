...
@Table(name = "users") //Table in DB Name = users
public class User {
    ...
    @Column(name = "id") //ColumName in DB = id
    private int id;
    ...
    // In many to many relations the data type is preferred to be a List for performance, in one to many and many to one
